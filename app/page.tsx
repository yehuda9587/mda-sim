      ...
      <div className="w-full max-w-2xl bg-white shadow-sm border border-slate-200 rounded-2xl p-6 mb-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            {isActive && (
              <button onClick={() => setIsPaused(!isPaused)} className="px-3 py-1 bg-slate-100 rounded-md text-xs font-bold text-slate-500 hover:bg-slate-200 active:scale-95 transition">
                {isPaused ? 'המשך ▶' : 'עצור ⏸'}
              </button>
            )}
